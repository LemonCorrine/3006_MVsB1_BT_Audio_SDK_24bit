...
const EffectComCt AudioEffectCommParam[]=
{
	...
	{2, NodeType_DynamicEqGroup0_LP,	EQ,			"2:Music DynamicEQLP",				24,  0x95},//0x93
	{2, NodeType_DynamicEqGroup0_HP,	EQ,			"2:Music DynamicEQHP",				24,  0x96},//0x94
	...
	{2, NodeType_Normal, 	VOCAL_CUT,				"2:Music VOCAL_CUT",				24,  0x94},//0x94
